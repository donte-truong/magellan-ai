...
- Graph revision increments per accepted research claim. Only the latest graph snapshot is available; requesting another revision returns 409. No historical revision is silently substituted.
